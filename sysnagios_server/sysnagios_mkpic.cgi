...
RRDTOOL=/usr/local/bin/rrdtool --font DEFAULT:0:/usr/share/fonts/bitstream-vera/VeraSe.ttf
...
debug "$RRDTOOL graph - -s -$TIME -a $IMGTYPE -v Gb -w $WIDTH -h $HEIGTH  DEF:var0=$RRDDIR/$RRDFILE:check_disk_home:AVERAGE LINE2:var0#ff0000:check_disk_data"
$RRDTOOL graph - -s -$TIME -a $IMGTYPE -v Gb -w $WIDTH -h $HEIGTH  DEF:var0=$RRDDIR/$RRDFILE:check_disk_home:AVERAGE LINE2:var0#ff0000:check_disk_data
