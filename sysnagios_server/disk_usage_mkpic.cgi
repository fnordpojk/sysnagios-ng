...
#$RRDTOOL graph - -s -$TIME -a $IMGTYPE -v '%' -w $WIDTH -h $HEIGTH  -l 0 -u 100 --rigid DEF:var0=$RRDDIR/$RRDFILE:Used:AVERAGE LINE2:var0#ff0000:"% Used"
$RRDTOOL graph - --font DEFAULT:0:/usr/share/fonts/bitstream-vera/VeraSe.ttf -v "%" -s -$TIME -a $IMGTYPE  -w $WIDTH -h $HEIGTH  -l 0 -u 100 --rigid DEF:var0=$RRDDIR/$RRDFILE:Used:AVERAGE LINE2:var0#ff0000:"% Used"
